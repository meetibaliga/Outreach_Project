...
public class ScaleFormEntry extends RadioFormEntry {
    ...
    public View getView() {
        ...
        // labels container
        ConstraintLayout labelContainer = new ConstraintLayout(getContext());
        labelContainer.setId(CONTAINER_VIEW_ID);
        labelContainer.setLayoutParams(new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));

        // min value
        minValue = new TextView(getContext());
        ...
        labelContainer.addView(minValue);

        // max
        maxValue = new TextView(getContext());
        ...
        labelContainer.addView(maxValue);

        // constraints
        ConstraintSet set = new ConstraintSet();
        set.clone(labelContainer);
        ...
        set.applyTo(labelContainer);

        superLayout.addView(labelContainer);
